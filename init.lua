...
package.preload["commands"] = package.preload["commands"] or function(...)
  ...
  local _local_362_ = require("commands.window-border")
  local show_active_border_command = _local_362_["show-active-border-command"]
  local show_inactive_border_command = _local_362_["show-inactive-border-command"]
  local hide_borders_command = _local_362_["hide-borders-command"]
...
package.preload["behaviors"] = package.preload["behaviors"] or function(...)
  ...
  local make_behavior_registry = _local_379_["make-behavior-registry"]
  local add_behavior_21 = _local_379_["add-behavior!"]
  local _local_380_ = require("events")
  local event_registry = _local_380_["event-registry"]
  local _local_381_ = require("commands")
  local command_registry = _local_381_["command-registry"]
  local _local_388_ = require("behaviors.compile-fennel")
  local compile_fennel_behavior = _local_388_["compile-fennel-behavior"]
  local _local_395_ = require("behaviors.reload-hammerspoon")
  local reload_hammerspoon_behavior = _local_395_["reload-hammerspoon-behavior"]
  local _local_399_ = require("behaviors.toggle-expose")
  local toggle_expose_behavior = _local_399_["toggle-expose-behavior"]
  local _local_404_ = require("behaviors.update-space-indicator")
  local update_space_indicator_behavior = _local_404_["update-space-indicator-behavior"]
  local _local_408_ = require("behaviors.open-emacs")
  local open_emacs_behavior = _local_408_["open-emacs-behavior"]
  local _local_414_ = require("behaviors.window-border")
  local update_on_focus_behavior = _local_414_["update-on-focus-behavior"]
  local update_on_move_behavior = _local_414_["update-on-move-behavior"]
...
package.preload["sheaf.behavior-registry"] = package.preload["sheaf.behavior-registry"] or function(...)
  local _local_363_ = require("lib.cljlib-shim")
  local some = _local_363_.some
  local _local_364_ = require("sheaf.event-registry")
  local valid_event_selector_3f = _local_364_["valid-event-selector?"]
  local _local_365_ = require("sheaf.command-registry")
  local command_defined_3f = _local_365_["command-defined?"]
  local _local_366_ = require("lib.hierarchy")
  local isa_3f = _local_366_["isa?"]
  ...
  local function behavior_responds_to_3f(registry, behavior_name, event_name)
    ...
    if (nil == behavior) then
      ...
      return some(_377_, behavior["respond-to"])
    end
  end
...
package.preload["behaviors.compile-fennel"] = package.preload["behaviors.compile-fennel"] or function(...)
  local _local_382_ = require("sheaf.behavior-registry")
  local make_behavior = _local_382_["make-behavior"]
  local compile_fennel_behavior
  local function _383_(file_change_event, candidates, send_cmd)
    local path
    do
      local t_384_ = file_change_event
      if (nil ~= t_384_) then
        t_384_ = t_384_["event-data"]
      else
      end
      if (nil ~= t_384_) then
        t_384_ = t_384_["file-path"]
      else
      end
      path = t_384_
    end
  ...
  compile_fennel_behavior = make_behavior({name = "compile-fennel.behaviors/compile-fennel", description = "Watch fennel files in hammerspoon folder and recompile them.", ["respond-to"] = {"event.kind.fs/file-change"}, commands = {compile = "compile-fennel.commands/compile"}, fn = _383_})
...
package.preload["behaviors.reload-hammerspoon"] = package.preload["behaviors.reload-hammerspoon"] or function(...)
  local _local_389_ = require("sheaf.behavior-registry")
  local make_behavior = _local_389_["make-behavior"]
  local reload_hammerspoon_behavior
  local function _390_(file_change_event, candidates, send_cmd)
    local path
    do
      local t_391_ = file_change_event
      if (nil ~= t_391_) then
        t_391_ = t_391_["event-data"]
      else
      end
      if (nil ~= t_391_) then
        t_391_ = t_391_["file-path"]
      else
      end
      path = t_391_
    end
  ...
  reload_hammerspoon_behavior = make_behavior({name = "reload-hammerspoon.behaviors/reload-hammerspoon", description = "When init.lua changes, reload hammerspoon.", ["respond-to"] = {"event.kind.fs/file-change"}, commands = {reload = "reload-hammerspoon.commands/reload"}, fn = _390_})
...
package.preload["behaviors.toggle-expose"] = package.preload["behaviors.toggle-expose"] or function(...)
  local _local_396_ = require("sheaf.behavior-registry")
  local make_behavior = _local_396_["make-behavior"]
  local toggle_expose_behavior
  local function _397_(event, candidates, send_cmd)
  ...
  toggle_expose_behavior = make_behavior({name = "expose.behaviors/toggle-expose", description = "Toggle the Hammerspoon Expose window picker", ["respond-to"] = {"event.kind.hotkey/pressed"}, commands = {["toggle-show"] = "expose.commands/toggle-show"}, fn = _397_})
...
package.preload["behaviors.update-space-indicator"] = package.preload["behaviors.update-space-indicator"] or function(...)
  ...
  local function _402_(event, candidates, send_cmd)
  ...
  update_space_indicator_behavior = make_behavior({name = "space-indicator.behaviors/update-on-change", description = "Update space indicator menubar when spaces or screens change", ["respond-to"] = {"event.kind.space/changed", "event.kind.screen/any"}, commands = {["update-menubar"] = "space-indicator.commands/update-menubar"}, fn = _402_})
...
package.preload["behaviors.open-emacs"] = package.preload["behaviors.open-emacs"] or function(...)
  local _local_405_ = require("sheaf.behavior-registry")
  local make_behavior = _local_405_["make-behavior"]
  local open_emacs_behavior
  local function _406_(event, candidates, send_cmd)
  ...
  open_emacs_behavior = make_behavior({name = "emacs.behaviors/open-emacs", description = "Open a new emacsclient frame on hotkey press", ["respond-to"] = {"event.kind.hotkey/pressed"}, commands = {["open-emacs"] = "emacs.commands/open-emacs"}, fn = _406_})
...
package.preload["behaviors.window-border"] = package.preload["behaviors.window-border"] or function(...)
  ...
  local make_behavior = _local_409_["make-behavior"]
  local update_on_focus_behavior
  local function _410_(event, candidates, send_cmd)
  ...
  update_on_move_behavior = make_behavior({name = "window-border.behaviors/update-on-move", description = "Reposition active border when a window moves or resizes", ["respond-to"] = {"event.kind.window/moved"}, commands = {["show-active"] = "window-border.commands/show-active-border"}, fn = _412_})
...
package.preload["subscriptions"] = package.preload["subscriptions"] or function(...)
  local _local_441_ = require("sheaf.subscription-registry")
  local make_subscription_registry = _local_441_["make-subscription-registry"]
  local define_subscription_21 = _local_441_["define-subscription!"]
  local _local_442_ = require("events")
  local event_registry = _local_442_["event-registry"]
  local _local_443_ = require("behaviors")
  local behavior_registry = _local_443_["behavior-registry"]
  local _local_444_ = require("components")
  local tag_registry = _local_444_["tag-registry"]
...
package.preload["sheaf.subscription-registry"] = package.preload["sheaf.subscription-registry"] or function(...)
  local _local_415_ = require("lib.cljlib-shim")
  local hash_set = _local_415_["hash-set"]
  local conj = _local_415_.conj
  local disj = _local_415_.disj
  local into = _local_415_.into
  local seq = _local_415_.seq
  local _local_416_ = require("sheaf.event-registry")
  local valid_event_selector_3f = _local_416_["valid-event-selector?"]
  local _local_417_ = require("sheaf.behavior-registry")
  local behavior_defined_3f = _local_417_["behavior-defined?"]
  local _local_418_ = require("sheaf.tag-registry")
  local get_tags = _local_418_["get-tags"]
  local _local_419_ = require("lib.hierarchy")
  local ancestors = _local_419_.ancestors
  ...
  local function index_remove_21(registry, subscription)
    ...
    if sub_set then
      do
        ...
        registry.index[tag][event] = _428_
      end
      if (nil == registry.index[tag][event]) then
...
local _local_445_ = require("subscriptions")
local subscription_registry = _local_445_["subscription-registry"]
package.preload["sheaf.dispatcher"] = package.preload["sheaf.dispatcher"] or function(...)
  local _local_446_ = require("sheaf.event-registry")
  local add_event_handler_21 = _local_446_["add-event-handler!"]
  local _local_447_ = require("sheaf.behavior-registry")
  local behavior_responds_to_3f = _local_447_["behavior-responds-to?"]
  local get_behavior = _local_447_["get-behavior"]
  local _local_448_ = require("sheaf.subscription-registry")
  local get_matching_subscriptions = _local_448_["get-matching-subscriptions"]
  local _local_449_ = require("sheaf.command-registry")
  local get_command = _local_449_["get-command"]
  local _local_450_ = require("sheaf.tag-registry")
  local components_with_tag = _local_450_["components-with-tag"]
  local _local_451_ = require("sheaf.component-registry")
  local get_component_instance = _local_451_["get-component-instance"]
  local _local_452_ = require("sheaf.trait-registry")
  local satisfies_all_3f = _local_452_["satisfies-all?"]
  local function build_candidates(behavior, command_registry, component_registry, trait_registry, tag_registry, target_tag)
    ...
    for alias, cmd_name in pairs((behavior.commands or {})) do
      ...
      local _454_
      do
        local t_453_ = command
        if (nil ~= t_453_) then
          t_453_ = t_453_["requires-traits"]
        else
        end
        _454_ = t_453_
      end
      required_traits = (_454_ or {})
      local matching = {}
  ...
  local function make_send_cmd(behavior, command_registry, component_registry, trait_registry)
    local function _457_(instance_name, cmd_alias, params)
  ...
  local function start_dispatcher_21(subscription_registry, component_registry)
    ...
    add_event_handler_21(event_registry, "dispatcher/behavior-router", _465_)
    local function _466_(event)
    ...
    return add_event_handler_21(event_registry, "dispatcher/debug-handler", _466_)
  end
  return {["start-dispatcher!"] = start_dispatcher_21}
end
local _local_468_ = require("sheaf.dispatcher")
local start_dispatcher_21 = _local_468_["start-dispatcher!"]
...
local _local_474_ = require("sheaf.event-loop")
local make_event_loop = _local_474_["make-event-loop"]
local start_event_loop_21 = _local_474_["start-event-loop!"]
