...
package.preload["commands"] = package.preload["commands"] or function(...)
  ...
  local _local_361_ = require("commands.window-border")
  local show_active_border_command = _local_361_["show-active-border-command"]
  local show_inactive_border_command = _local_361_["show-inactive-border-command"]
  local hide_borders_command = _local_361_["hide-borders-command"]
...
package.preload["commands.window-border"] = package.preload["commands.window-border"] or function(...)
  ...
  local function _357_(component, params)
    do
      local bw = component.state["border-width"]
      local cr = resolve_corner_radius(params["window-id"], component.state["default-corner-radius"])
  ...
  show_inactive_border_command = make_command("window-border.commands/show-inactive-border", "Position and show the inactive window border around a window frame", {["requires-traits"] = {"trait/has-canvas"}, fn = _357_})
  ...
  hide_borders_command = make_command("window-border.commands/hide-borders", "Hide both active and inactive window border overlays", {["requires-traits"] = {"trait/has-canvas"}, fn = _358_})
...
package.preload["behaviors"] = package.preload["behaviors"] or function(...)
  local _local_378_ = require("sheaf.behavior-registry")
  local make_behavior_registry = _local_378_["make-behavior-registry"]
  local add_behavior_21 = _local_378_["add-behavior!"]
  local _local_379_ = require("events")
  local event_registry = _local_379_["event-registry"]
  local _local_380_ = require("commands")
  local command_registry = _local_380_["command-registry"]
  local _local_387_ = require("behaviors.compile-fennel")
  local compile_fennel_behavior = _local_387_["compile-fennel-behavior"]
  local _local_394_ = require("behaviors.reload-hammerspoon")
  local reload_hammerspoon_behavior = _local_394_["reload-hammerspoon-behavior"]
  local _local_398_ = require("behaviors.toggle-expose")
  local toggle_expose_behavior = _local_398_["toggle-expose-behavior"]
  local _local_403_ = require("behaviors.update-space-indicator")
  local update_space_indicator_behavior = _local_403_["update-space-indicator-behavior"]
  local _local_407_ = require("behaviors.open-emacs")
  local open_emacs_behavior = _local_407_["open-emacs-behavior"]
  local _local_413_ = require("behaviors.window-border")
  local update_on_focus_behavior = _local_413_["update-on-focus-behavior"]
  local update_on_move_behavior = _local_413_["update-on-move-behavior"]
...
package.preload["sheaf.behavior-registry"] = package.preload["sheaf.behavior-registry"] or function(...)
  local _local_362_ = require("lib.cljlib-shim")
  local some = _local_362_.some
  local _local_363_ = require("sheaf.event-registry")
  local valid_event_selector_3f = _local_363_["valid-event-selector?"]
  local _local_364_ = require("sheaf.command-registry")
  local command_defined_3f = _local_364_["command-defined?"]
  local _local_365_ = require("lib.hierarchy")
  local isa_3f = _local_365_["isa?"]
  ...
  local function behavior_responds_to_3f(registry, behavior_name, event_name)
    ...
    if (nil == behavior) then
      ...
      return some(_376_, behavior["respond-to"])
    end
  end
...
package.preload["behaviors.compile-fennel"] = package.preload["behaviors.compile-fennel"] or function(...)
  local _local_381_ = require("sheaf.behavior-registry")
  local make_behavior = _local_381_["make-behavior"]
  local compile_fennel_behavior
  local function _382_(file_change_event, candidates, send_cmd)
    local path
    do
      local t_383_ = file_change_event
      if (nil ~= t_383_) then
        t_383_ = t_383_["event-data"]
      else
      end
      if (nil ~= t_383_) then
        t_383_ = t_383_["file-path"]
      else
      end
      path = t_383_
    end
  ...
  compile_fennel_behavior = make_behavior({name = "compile-fennel.behaviors/compile-fennel", description = "Watch fennel files in hammerspoon folder and recompile them.", ["respond-to"] = {"event.kind.fs/file-change"}, commands = {compile = "compile-fennel.commands/compile"}, fn = _382_})
...
package.preload["behaviors.reload-hammerspoon"] = package.preload["behaviors.reload-hammerspoon"] or function(...)
  local _local_388_ = require("sheaf.behavior-registry")
  local make_behavior = _local_388_["make-behavior"]
  local reload_hammerspoon_behavior
  local function _389_(file_change_event, candidates, send_cmd)
    local path
    do
      local t_390_ = file_change_event
      if (nil ~= t_390_) then
        t_390_ = t_390_["event-data"]
      else
      end
      if (nil ~= t_390_) then
        t_390_ = t_390_["file-path"]
      else
      end
      path = t_390_
    end
  ...
  reload_hammerspoon_behavior = make_behavior({name = "reload-hammerspoon.behaviors/reload-hammerspoon", description = "When init.lua changes, reload hammerspoon.", ["respond-to"] = {"event.kind.fs/file-change"}, commands = {reload = "reload-hammerspoon.commands/reload"}, fn = _389_})
...
package.preload["behaviors.toggle-expose"] = package.preload["behaviors.toggle-expose"] or function(...)
  local _local_395_ = require("sheaf.behavior-registry")
  local make_behavior = _local_395_["make-behavior"]
  local toggle_expose_behavior
  local function _396_(event, candidates, send_cmd)
  ...
  toggle_expose_behavior = make_behavior({name = "expose.behaviors/toggle-expose", description = "Toggle the Hammerspoon Expose window picker", ["respond-to"] = {"event.kind.hotkey/pressed"}, commands = {["toggle-show"] = "expose.commands/toggle-show"}, fn = _396_})
...
package.preload["behaviors.update-space-indicator"] = package.preload["behaviors.update-space-indicator"] or function(...)
  local _local_399_ = require("sheaf.behavior-registry")
  local make_behavior = _local_399_["make-behavior"]
  ...
  local function _401_(event, candidates, send_cmd)
  ...
  update_space_indicator_behavior = make_behavior({name = "space-indicator.behaviors/update-on-change", description = "Update space indicator menubar when spaces or screens change", ["respond-to"] = {"event.kind.space/changed", "event.kind.screen/any"}, commands = {["update-menubar"] = "space-indicator.commands/update-menubar"}, fn = _401_})
...
package.preload["behaviors.open-emacs"] = package.preload["behaviors.open-emacs"] or function(...)
  local _local_404_ = require("sheaf.behavior-registry")
  local make_behavior = _local_404_["make-behavior"]
  local open_emacs_behavior
  local function _405_(event, candidates, send_cmd)
  ...
  open_emacs_behavior = make_behavior({name = "emacs.behaviors/open-emacs", description = "Open a new emacsclient frame on hotkey press", ["respond-to"] = {"event.kind.hotkey/pressed"}, commands = {["open-emacs"] = "emacs.commands/open-emacs"}, fn = _405_})
...
package.preload["behaviors.window-border"] = package.preload["behaviors.window-border"] or function(...)
  ...
  local make_behavior = _local_408_["make-behavior"]
  ...
  update_on_move_behavior = make_behavior({name = "window-border.behaviors/update-on-move", description = "Reposition active border when a window moves or resizes", ["respond-to"] = {"event.kind.window/focused"}, commands = {["show-active"] = "window-border.commands/show-active-border"}, fn = _411_})
...
package.preload["subscriptions"] = package.preload["subscriptions"] or function(...)
  local _local_440_ = require("sheaf.subscription-registry")
  local make_subscription_registry = _local_440_["make-subscription-registry"]
  local define_subscription_21 = _local_440_["define-subscription!"]
  local _local_441_ = require("events")
  local event_registry = _local_441_["event-registry"]
  local _local_442_ = require("behaviors")
  local behavior_registry = _local_442_["behavior-registry"]
  local _local_443_ = require("components")
  local tag_registry = _local_443_["tag-registry"]
...
package.preload["sheaf.subscription-registry"] = package.preload["sheaf.subscription-registry"] or function(...)
  local _local_414_ = require("lib.cljlib-shim")
  local hash_set = _local_414_["hash-set"]
  local conj = _local_414_.conj
  local disj = _local_414_.disj
  local into = _local_414_.into
  local seq = _local_414_.seq
  local _local_415_ = require("sheaf.event-registry")
  local valid_event_selector_3f = _local_415_["valid-event-selector?"]
  local _local_416_ = require("sheaf.behavior-registry")
  local behavior_defined_3f = _local_416_["behavior-defined?"]
  local _local_417_ = require("sheaf.tag-registry")
  local get_tags = _local_417_["get-tags"]
  local _local_418_ = require("lib.hierarchy")
  local ancestors = _local_418_.ancestors
  ...
  local function index_remove_21(registry, subscription)
    ...
    if sub_set then
      do
        ...
        registry.index[tag][event] = _427_
      end
      if (nil == registry.index[tag][event]) then
...
local _local_444_ = require("subscriptions")
local subscription_registry = _local_444_["subscription-registry"]
package.preload["sheaf.dispatcher"] = package.preload["sheaf.dispatcher"] or function(...)
  ...
  local add_event_handler_21 = _local_445_["add-event-handler!"]
  local _local_446_ = require("sheaf.behavior-registry")
  local behavior_responds_to_3f = _local_446_["behavior-responds-to?"]
  local get_behavior = _local_446_["get-behavior"]
  local _local_447_ = require("sheaf.subscription-registry")
  local get_matching_subscriptions = _local_447_["get-matching-subscriptions"]
  local _local_448_ = require("sheaf.command-registry")
  local get_command = _local_448_["get-command"]
  local _local_449_ = require("sheaf.tag-registry")
  local components_with_tag = _local_449_["components-with-tag"]
  local _local_450_ = require("sheaf.component-registry")
  local get_component_instance = _local_450_["get-component-instance"]
  local _local_451_ = require("sheaf.trait-registry")
  local satisfies_all_3f = _local_451_["satisfies-all?"]
  local function build_candidates(behavior, command_registry, component_registry, trait_registry, tag_registry, target_tag)
    ...
    for alias, cmd_name in pairs((behavior.commands or {})) do
      ...
      local _453_
      do
        local t_452_ = command
        if (nil ~= t_452_) then
          t_452_ = t_452_["requires-traits"]
        else
        end
        _453_ = t_452_
      end
      required_traits = (_453_ or {})
      local matching = {}
  ...
  local function make_send_cmd(behavior, command_registry, component_registry, trait_registry)
    local function _456_(instance_name, cmd_alias, params)
  ...
  local function start_dispatcher_21(subscription_registry, component_registry)
    ...
    add_event_handler_21(event_registry, "dispatcher/behavior-router", _464_)
    local function _465_(event)
    ...
    return add_event_handler_21(event_registry, "dispatcher/debug-handler", _465_)
  end
  return {["start-dispatcher!"] = start_dispatcher_21}
end
local _local_467_ = require("sheaf.dispatcher")
local start_dispatcher_21 = _local_467_["start-dispatcher!"]
...
local _local_473_ = require("sheaf.event-loop")
local make_event_loop = _local_473_["make-event-loop"]
local start_event_loop_21 = _local_473_["start-event-loop!"]
